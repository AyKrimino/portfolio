...
import { Github, ExternalLink, Star, Lock, ArrowUpRight } from "lucide-react";
                ...
                <div className="flex flex-wrap items-center gap-3 mt-4">
                  ...
                  {caseStudy && (
                    <Link
                      ...
                      className="group/cs inline-flex items-center gap-1.5 text-sm font-semibold text-primary hover:underline sm:ml-auto"
                    >
                      View Case Study
                      <ArrowUpRight className="h-4 w-4 transition-transform duration-200 group-hover/cs:translate-x-0.5 group-hover/cs:-translate-y-0.5" />
                    </Link>
                  )}
                </div>
              </CardContent>
