...
const HeroSection = () => {
  return (
    <section className="flex flex-col items-center justify-center gap-4 lg:gap-6 min-h-screen px-4 sm:px-6 lg:px-8 text-center">
      ...
      <button className="mt-4" type="button" aria-label="Scroll down">
