...
export const SKILLS: SkillCategory[] = [
  {
    ...
    items: [
      ...
      { id: "rust", name: "Rust", level: "beginner", logos: ["rust-logo.svg"] },
      { id: "c", name: "C/C++", level: "beginner", logos: ["c-logo.svg", "cpp-logo.svg"] },
    ],
  },
  {
    id: "frameworks",
    ...
    items: [
      ...
      { id: "gin", name: "Gin", level: "advanced", logos: ["gin-logo.svg"] },
      ...
      { id: "zustand", name: "Zustand", level: "beginner", logos: ["zustand-logo.svg"] },
    ],
  },
  {
    id: "databases",
    ...
    items: [
      { id: "sqlite", name: "SQLite", level: "intermediate", logos: ["sqlite-logo.svg"] },
      { id: "mysql", name: "MySQL", level: "advanced", logos: ["mysql-logo.svg"] },
      { id: "postgres", name: "PostgreSQL", level: "advanced", logos: ["postgres-logo.svg"] },
      { id: "redis", name: "Redis", level: "beginner", logos: ["redis-logo.svg"] },
      { id: "nats", name: "NATS", level: "advanced", logos: ["nats-logo.png"] },
      { id: "rabbitmq", name: "RabbitMQ", level: "beginner", logos: ["rabbitmq-logo.svg"] },
    ],
  },
  {
    id: "tools",
    ...
    items: [
      ...
      { id: "gitlab", name: "Gitlab", level: "intermediate", logos: ["gitlab-logo.svg"] },
      { id: "docker", name: "Docker", level: "intermediate", logos: ["docker-logo.svg"] },
      { id: "dockercompose", name: "Docker Compose", level: "advanced", logos: ["docker-logo.svg"] },
      ...
      { id: "zed", name: "Zed", level: "intermediate", logos: ["zed-logo.svg"] },
      { id: "nginx", name: "Nginx", level: "beginner", logos: ["nginx-logo.svg"] },
    ],
  },
];
